    ...
    try {
      ...
      if (error.code === 'P2002') {
        throw new ConflictException(
          'El correo o el empleado ya tienen un usuario asignado'
        );
      }
  ...
  async login(
    ...
    return {
      ...
      usuario: {
        ...
        nombreCompleto:
          `${user.empleados?.nombres} ${user.empleados?.apellidos}`
      }
    };
  }
  ...
  async update(
    ...
    try {
      ...
      if (
        ...
        if (error.code === 'P2002') {
          throw new ConflictException(
            'Este empleado ya tiene un usuario asignado o el correo está en uso.'
          );
        }
      }
